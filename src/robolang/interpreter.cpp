...
void Interpreter::prepare(const char *configFile, const char *stratFile) {
    parser.parse_config(configFile);
    parser.parse_strategy(stratFile);
}
